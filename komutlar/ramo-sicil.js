...
if(!["823185187738353686", "823185188380606475", "823185186803941426", "823185186065874985"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
.setFooter(`V E N U S | M O D E R A T I O N`))
};
