...
if(!["823185186065874985"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
let guild = "823184920162598933"; // SUNUCU ID
...
var booster = message.guild.roles.cache.get("826888494176796702").members.size
